...
<title>View Registered Farmers - Agricultural Portal</title>
<style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="View_Admin_Krishi_Expert.jsp">
                
                <span>View Krishi Expert</span>
            </a></li>
            <li><a href="View_Register_Farmer.jsp" class="active">
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <p>View all registered farmers in the agricultural portal system</p>
            </div>
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td colspan="4" class="no-data">No farmer records found</td>
                        </tr>
                        <%
                            }
                        } catch (Exception e) {
